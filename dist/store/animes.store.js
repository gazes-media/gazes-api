  ...
  each object.*/ function fetchAll() {
                ...
                return _async_to_generator(function () {
                    return _ts_generator(this, function (_state) {
                        switch (_state.label) {
                            case 0:
                                return [4, _axios.default.get(vostfrUrl)];
                            case 1:
                                _this.vostfr = _state.sent().data;
                                return [4, _axios.default.get(vfUrl)];
                            case 2:
                                _this.vf = _state.sent().data;
                                _this.all = _to_consumable_array(_this.vostfr).concat(_to_consumable_array(_this.vf));
                                return [2];
                        }
                    });
                })();
  ...
  and stores them in an array. */ function fetchLatest() {
                ...
                return _async_to_generator(function () {
                    ...
                    return _ts_generator(this, function (_state) {
                        switch (_state.label) {
                            case 0:
                                return [4, _axios.default.get("https://neko.ketsuna.com")];
                            case 1:
                    ...
                    return _ts_generator(this, function (_state) {
                        switch (_state.label) {
                            case 0:
                                ...
                                if (!anime) return [2, Promise.resolve(undefined)];
                                return [4, _axios.default.get("https://neko.ketsuna.com/".concat(anime.url))];
                            case 1:
                                        ...
                                        return _ts_generator(this, function (_state) {
                                            switch (_state.label) {
                                                case 0:
                                                    ...
                                                    return [4, _axios.default.get(episodeUrl)];
                                                case 1:
                                                    (_ref = _state.sent()), (nekoData = _ref.data);
                                                    pstreamUrl = (_exec = /(\n(.*)video\[0] = ')(.*)(';)/gm.exec(nekoData)) === null || _exec === void 0 ? void 0 : _exec[3];
                                                    if (!pstreamUrl) return [2, resolve(undefined)];
                                                    return [4, _axios.default.get("https://proxy.ketsuna.com/?url=".concat(encodeURIComponent(pstreamUrl)))];
                                                case 2:
                                                ...
                                                case 3:
                                                    ...
                                                    _state.label = 4;
                                                case 4:
                                                    if (!!(_iteratorNormalCompletion = (_step = _iterator.next()).done)) return [3, 7];
                                                    scriptSrc = _step.value;
                                                    if (scriptSrc.includes("cloudflare-static")) return [3, 6];
                                                    return [4, _axios.default.get("https://proxy.ketsuna.com/?url=".concat(encodeURIComponent(scriptSrc)))];
                                                case 5:
                                                    (_ref2 = _state.sent()), (pstreamScript = _ref2.data);
                                                    m3u8UrlB64 =
                                                        (_exec1 = /e.parseJSON\(atob\(t\).slice\(2\)\)\}\(\"([^;]*)"\),/gm.exec(pstreamScript)) === null || _exec1 === void 0 ? void 0 : _exec1[1];
                                                    if (m3u8UrlB64) {

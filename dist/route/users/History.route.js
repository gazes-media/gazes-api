                    ...
                    return _ts_generator(this, function (_state) {
                        switch (_state.label) {
                            ...
                            case 1:
                                ...
                                animes = userHistory.reduce(function (acc, anime) {
                                    var a = acc.find(function (a) {
                                        return a.id === anime.id;
                                    });
                                    if (a) a.episodes.push(_object_spread({}, anime));
                                    else
                                        acc.push({
                                            id: anime.id,
                                            episodes: [_object_spread({}, anime)],
                                        });
                                    return acc;
                                }, []);

    ...
    function UserFavorisRoute() {
        ...
        _define_property(_assert_this_initialized(_this), "handler", function() {
            var _ref = _async_to_generator(function(request, reply) {
                var body, favoriteRepository, favorites, animes;
                return _ts_generator(this, function(_state) {
                    switch(_state.label){
                        ...
                        case 1:
                            ...
                            animes = favorites.filter(function(a) {
                                return _animesstore.AnimeStore.vostfr.find(function(anime) {

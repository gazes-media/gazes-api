...
var AnimesIdEpisodeRoute = /*#__PURE__*/ (function (Route) {
    ...
    function AnimesIdEpisodeRoute() {
      ...
      received in the request. */ if (isNaN(id)) {
                                ...
                                return [4, _animesstore.AnimeStore.get(id.toString(), "vostfr")];
                            case 1:
                                animeVostfr = _state.sent();
                                if (
                                    animeVostfr.episodes.filter(function (e) {
                                ...
                                return [4, _animesstore.AnimeStore.getEpisodeVideo(episode)];
                            case 2:
                                ...
                                if (!animeVf) return [3, 5];
                                return [4, _animesstore.AnimeStore.get(id.toString(), "vf")];
                            case 3:
                                animeVf = _state.sent();
                                if (
                                    !(
                                        animeVf.episodes.filter(function (e) {
                                            return e.num === episodeNumber;
                                        }).length > 0
                                    )
                                )
                                ...
                                return [4, _animesstore.AnimeStore.getEpisodeVideo(episodeVf)];
                            case 4:
                                datas = _state.sent();
                                if (datas) {

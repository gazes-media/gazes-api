...
Object.defineProperty(exports, "AnimesLangIdEpisodeRoute", {
    enumerable: true,
    get: function() {
        return AnimesLangIdEpisodeRoute;
    }
});
...
var AnimesLangIdEpisodeRoute = /*#__PURE__*/ function(Route) {
    "use strict";
    _inherits(AnimesLangIdEpisodeRoute, Route);
    var _super = _create_super(AnimesLangIdEpisodeRoute);
    function AnimesLangIdEpisodeRoute() {
        _class_call_check(this, AnimesLangIdEpisodeRoute);
        var _this;
        _this = _super.apply(this, arguments);
        _define_property(_assert_this_initialized(_this), "url", "/animes/:lang/:id/:episodeNumber");
                    ...
                    return [
                        ...
                        new Promise(function() {
                            var _ref = _async_to_generator(function(resolve, reject) {
                                var _request_params, lang, id, episodeNumber, anime, episode, _ref, uri, subtitlesVtt, baseUrl;
                                return _ts_generator(this, function(_state) {
                                    switch(_state.label){
                                        case 0:
      ...
      received in the request. */ if (lang !== "vf" && lang !== "vostfr") return [
                                        ...
                                        case 2:
                                            ...
                                            return [
                                                2,
                                                resolve(reply.status(200).send(_object_spread({
                                                    videoUri: uri,
                                                    videoVtt: subtitlesVtt,
